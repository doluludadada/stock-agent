...
from backend.src.a_domain.model.trading.order import Order
from backend.src.a_domain.model.trading.position import Position


class IBrokerProvider(Protocol):
    """
